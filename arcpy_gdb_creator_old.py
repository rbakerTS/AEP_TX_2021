...
class DataContainer:
    def __init__(self, rows, column_pos=0):
        self._rows = rows
        self._columns = None
...
class PoleDataContainer(DataContainer):
    def __init__(self, row, column_pos=0):
        super().__init__(row, column_pos)
...
if __name__ == '__main__':
    ...
    t = ThreadingManager()
    poles_name = 'AEP_Abilene_Poles_v2'
    root = r'Y:\AEP Abilene Poles v2'
    gdb_name = poles_name
    gdb_file_name = f'{gdb_name}.gdb'
    ...
    # Image Attachment CSV *********************************************************************************************
    print(f"Reading image tables")
    ...
    data = PoleDataContainer(pole_csv_data)
